...
def main():
    ...
    parser_json2csv = subparsers.add_parser(
        "json2csv", help="Конвертировать JSON в CSV", add_help=False
    )
    parser_json2csv.add_argument(
    ...
    parser_csv2json = subparsers.add_parser(
        "csv2json", help="Конвертировать CSV в JSON", add_help=False
    )
    parser_csv2json.add_argument(
    ...
    parser_csv2xlsx = subparsers.add_parser(
        "csv2xlsx", help="Конвертировать CSV в XLSX", add_help=False
    )
